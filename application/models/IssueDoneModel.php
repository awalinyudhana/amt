        ...
        if(!empty($_FILES['filename']['name'])) {
            ...
            for ($i = 0; $i < $filesCount; $i++) {
                ...
                if (isset($_FILES['filename']['size']) && ($_FILES['filename']['size'] > 0)) {
                    ...
                    //list($imgWidth, $imgHeight) = getimagesize($uploadPath.'/'.$fileData['file_name']);

                    if( $_FILES['filename']['size'] > 1024 ) {

                        $configR['source_image'] = $uploadPath.'/'.$fileData['file_name'];
                        //$config['new_image'] = $uploadPath.'/'.$fileData['file_name'];
